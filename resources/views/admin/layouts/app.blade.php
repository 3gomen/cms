    ...
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Mobilpont CMS</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/accessories" active-class="active" class="nav-link">
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/devices" active-class="active" class="nav-link">
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/parts" active-class="active" class="nav-link">
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/repairs" active-class="active" class="nav-link">
